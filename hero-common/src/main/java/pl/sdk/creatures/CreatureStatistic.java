...
public enum CreatureStatistic implements CreatureStatisticlf {
    ...
    WRAITH("Wraith",7,7,18,7,Range.closed(3,5),3,"Will get to those shooters even faster and will really annoy spellcasting heroes by slowly draining their mana! \n Special Abilities: Top wight of the stack regenerates all lost damage in the beginning of each round.", true),
    ...
    POWER_LICH("PowerLich",13,10,40,7,Range.closed(11,15),5,"Now they last longer and are able to do more damage! A must for good necropolis army. \nSpecial Abilities: Death cloud range attack - damages living creatures on adjacent hexes to target.", true,24),
    DREAD_KNIGHT("DreadKnight",18,18,120,9,Range.closed(15,30),6,"I think it's the best lvl6 unit in the game! Double damage ability puts Dread Knights above Naga Queens. \nSpecial Abilities:  20% chance to do double damage.", true),
