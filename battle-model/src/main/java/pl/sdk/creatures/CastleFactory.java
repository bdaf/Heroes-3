            ...
            switch (aTier) {
                ...
                case 7:
                    return new Creature.Builder()
                            ...
                            .damageCalculator(new DamageIncreaseAgainstParticularCreatureNameCalcDecorator(new DefaultDamageCalculator(), "devil", 1.5))
                            .amount(amount)
                            .build();
                default:
            ...
            switch (aTier) {
                ...
                case 7:
                    return new Creature.Builder()
                            ...
                            .damageCalculator(new DamageIncreaseAgainstParticularCreatureNameCalcDecorator(new DamageIncreaseInRandomChanceCalculator(new DefaultDamageCalculator(), CHANCE_TO_CRITICAL_ATTACK, INCREASE_FACTOR_OF_CRITICAL_ATTACK), "devil", 1.5))
                            .amount(amount)
                            .build();
                default:
                    throw new IllegalArgumentException(ERROR_MSG);
