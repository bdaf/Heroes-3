            ...
            switch (aTier) {
                case 1:
                    return new Creature.Builder()
                            ...
                            .damageCalculator(new DamageIncreaseInRandomChanceCalculator(CHANCE_TO_CRITICAL_ATTACK, INCREASE_FACTOR_OF_CRITICAL_ATTACK))
                            .build();
                case 2:
                ...
                case 7:
                    return new Creature.Builder()
                            ...
                            .damageCalculator(new DamageIncreaseAgainstParticularCreatureNameCalculator("devil",1.5))
                            .amount(amount)
                            .build();
                default:
